...
console.log(getData.users.length);
...
const result = Promise.resolve("The PROMISE was RESOLVED")
  .then((x) => getLoginList(x))
  .then((x) => console.log(x))

result
  .then((getData) => getLoginList(getData))
  .then((x) => console.log(x))
// Your code goes here ...
